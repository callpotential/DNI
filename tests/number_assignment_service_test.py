...
class number_assignment_service_test(unittest.TestCase):
    """
    ...
    def test_should_return_true_when_existing_session(self, get_session_item, refresh_ttl):
        ...
        session_item = session_information_log(mock_session_information_log_dict())
    ...
    def test_should_return_false_when_no_existing_session(self, get_expired_item, get_replacement_map):
        ...
        get_replacement_map.return_value = replacement_number_map(mock_replacement_number_map_dict())
    ...
    def test_should_return_false_when_pool_is_full(self, create_session_item, get_business_object,
        ...
        parsed_url = mock_parsed_url()
        get_replacement_map.return_value = replacement_number_map(mock_replacement_number_map_dict())
        get_expired_item.return_value = assignment_pool(mock_assignment_pool_dict())
        get_business_object.return_value = business_config(mock_business_config_dict())
        create_session_item.return_value = session_information_log(mock_session_information_log_dict())
