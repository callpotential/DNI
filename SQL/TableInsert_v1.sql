...
INSERT INTO `dni`.`assignmentpool` (`poolid`,`businessid`,`poolphonenumber`,`ttl`,`assignedroutingnumber`,`sessionid`)
VALUES(1290390360,1290394444,"234-223-4002",now(),"234-223-4011",1);
INSERT INTO `dni`.`assignmentpool` (`poolid`,`businessid`,`poolphonenumber`,`ttl`,`assignedroutingnumber`,`sessionid`)
VALUES(1290390360,1290394444,"234-223-4003",now(),"234-223-4011",1);
INSERT INTO `dni`.`assignmentpool` (`poolid`,`businessid`,`poolphonenumber`,`ttl`,`assignedroutingnumber`,`sessionid`)
VALUES(1290390360,1290394444,"234-223-4004",now(),"234-223-4011",1);
INSERT INTO `dni`.`assignmentpool` (`poolid`,`businessid`,`poolphonenumber`,`ttl`,`assignedroutingnumber`,`sessionid`)
VALUES(1290390360,1290394444,"234-223-4005",now(),"234-223-4011",1);
...
VALUES (1,1290390360,1290394444,True,"234-123-4323","234-223-4011","234-223-4001",DATE_ADD(now(),interval 2 hour),NULL,NULL, 
